...
function love.load(arg)
	...
	if skipintro then
		...
		intro:init()
		table.insert(app_state_functions, intro)
		intro.finished = function()
			menu_load()
			tableremoveitem(app_state_functions,intro)
		end
	end
	add("Intro Load")
	print("=======================\nDONE!")
...
function love.update(dt)
	...
	while steptimer >= targetdt do
		...
		for k,v in ipairs(app_state_functions) do
			v:update(dt)
		end
...
function tableremoveitem(tab, val)
